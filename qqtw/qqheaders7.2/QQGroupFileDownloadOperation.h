...
@class NSDictionary, NSFileHandle, NSMutableData, NSString, NSURLSession, NSURLSessionTask, QQGroupFileDownloadTask, QQGroupFileOIDBRequest;

@interface QQGroupFileDownloadOperation : QQGroupFileOperation <QQGroupFileOIDBRespondDelegate, NSURLSessionDataDelegate>
{
    NSMutableData *_cacheData;
    NSDictionary *_downloadRespondInfo;
