...
@interface EmojiStore : NSObject <IEngineDispatchDelegate, UIAlertViewDelegate>
{
    ...
    NSMutableDictionary *_footerJumpFlagDict;
    NSMutableArray *_recommendInfos;
    _Bool _needSyncMagic;
    _Bool _canSyncMagic;
    _Bool _isExistemojiStoreDir;
...
- (id)emojiAPNGRecvFilePath:(id)arg1;
...
- (id)emojiStoreRecommendInfoFilePath;
...
- (id)getAPNGEmojiSupportSize:(id)arg1;
...
- (id)getJumpRecommendInfo:(unsigned long long)arg1;
...
@property(nonatomic) _Bool isExistemojiStoreDir; // @synthesize isExistemojiStoreDir=_isExistemojiStoreDir;
...
- (_Bool)requestEmojiDownload:(id)arg1 key:(id)arg2 packageId:(unsigned long long)arg3 isMagic:(_Bool)arg4 rscType:(int)arg5 width:(unsigned long long)arg6 height:(unsigned long long)arg7 isAPNG:(_Bool)arg8 completion:(CDUnknownBlockType)arg9;
...
- (void)requestJumpRecommendInfos:(unsigned int)arg1;
- (void)requestJumpRecommendInfosIfNeeds:(unsigned long long)arg1;
...
- (void)responseOnJumpRecommendReceived:(struct CPBMessageDecoder *)arg1 ret:(int)arg2 context:(id)arg3;
...
- (void)setJumpRecommendInfo:(id)arg1 forPakcage:(unsigned long long)arg2;
...
- (void)syncRecommendInfosToLocal;
