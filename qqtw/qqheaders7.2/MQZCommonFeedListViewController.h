...
#import "QZoneHomepageShareViewDelegate.h"

@class AddFriendSendMessageViewController, MQZFavourOperater, NSDate, NSMutableArray, NSMutableDictionary, NSString, QUIActionSheet, QUIShareView, QZSpeciallyFollowBannerView, QZoneHomepageShareView;

@interface MQZCommonFeedListViewController : MQZoneOperatableViewController <QUIShareDelegate, QZoneHomepageShareViewDelegate>
{
...
- (void)onFollowBannerClicked:(long long)arg1;
