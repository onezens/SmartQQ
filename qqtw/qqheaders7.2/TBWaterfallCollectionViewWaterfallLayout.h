...
@interface TBWaterfallCollectionViewWaterfallLayout : UICollectionViewLayout
{
    ...
    id <TBWaterfallCollectionViewDelegateWaterfallLayout> _delegate;
...
- (void)commonInit;
- (void)dealloc;
@property(nonatomic) __weak id <TBWaterfallCollectionViewDelegateWaterfallLayout> delegate; // @synthesize delegate=_delegate;
...
- (struct CGRect)getCellFrameForIndexPath:(id)arg1;
