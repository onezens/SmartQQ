...
@class NSDictionary, NSMutableArray, NSString, QQAlertView, QQAsynUrlImageView, QQHttpClientSession, UITableView;
...
- (void)reqBinding;
- (void)reqBindingOld;
@property(retain, nonatomic) NSDictionary *schemaParams; // @synthesize schemaParams=_schemaParams;
