...
+ (void)disableCrashMonitor;
+ (void)enableCrashMonitor;
+ (id)generateLiveReport;
+ (void)installKSCrash:(_Bool)arg1;
+ (void)printLogToMMap:(const char *)arg1;
...
+ (void)resetDeadlockWatchdogInterval:(double)arg1;
+ (id)sdkVersion;
