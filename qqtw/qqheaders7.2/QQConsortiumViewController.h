...
@class NSMutableArray, NSMutableDictionary, NSString, NSTimer, QQAVChatControlBar, QQAVNoticeView, QQAVTipsView, QQAVWebViewController, QQCollectionView, QQConsortiumAddFriendView, QQConsortiumInfo, QQWebShareActionSheet, QUIAlertView, TUDotIndicator, UILabel, UIView;

@interface QQConsortiumViewController : QQMulAVChatBaseViewController <QQAVMaskAddFriendViewDelegate, ActionSheetDataDelegate, QQCollectionViewDataSource, QQCollectionViewDelegate, QQAVChatControlBarDelegate, QQAVTipsViewDelegate, QUIAlertViewDelegate>
{
    ...
    QQConsortiumInfo *_consortiumInfo;
    QQWebShareActionSheet *_shareActionSheet;
    QQAVWebViewController *_gameWebViewController;
    QQConsortiumAddFriendView *_addFriendView;
...
- (void)autoCloseConsortiumControllerWhenAccpetThirdCall;
...
- (id)initWithConsortiumInfo:(id)arg1 relationType:(int)arg2 busniessType:(int)arg3;
- (void)installKeyNotifications;
- (void)installNormalNotifications;
- (_Bool)isFullScreenChatting;
- (id)jsonToProfileModel:(id)arg1;
- (id)nameTitiled:(id)arg1 name:(id)arg2;
